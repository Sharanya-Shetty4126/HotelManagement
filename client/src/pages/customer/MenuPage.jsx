...
export default function MenuPage() {
  ...
  // Get session code information passed from the previous page
  const location = useLocation();
  const { sessionCode, newSession } = location.state || {};
    ...
    <div className="pb-24">
      ...
      {newSession && sessionCode && (
        <div className="bg-green-50 border-2 border-green-300 rounded-lg p-4 mb-6 text-center">
          ...
          <p className="text-3xl font-bold text-green-700 my-2 tracking-widest">
            {sessionCode}
          </p>
